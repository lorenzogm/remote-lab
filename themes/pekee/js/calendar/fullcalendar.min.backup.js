...
(function (m, ma) {
    ...
    function Zb(a, b) {
        ...
        function f(u) {
            var fa = m("<td class='fc-header-" + u + "'/>line295");
            (u = b.header[u]) && m.each(u.split(" "), function (oa) {
                oa > 0 && fa.append("<span class='fc-header-space'/>line297");
                var ga;
                m.each(this.split(","), function (ra, sa) {
                    if (sa == "title") {
                        fa.append("<span class='fc-header-title'>line301<h2>&nbsp;</h2></span>");
                        ...
                        if (ha) {
                            ...
                            var da = jb(b.buttonText, sa),
                                na = m("<span class='fc-button fc-button-" + sa + " " + q + "-state-default'>line314<span class='fc-button-inner'>line314-2<span class='fc-button-content'>line314-3" + (ra ? "<span class='fc-icon-wrap'>line314-4<span class='ui-icon ui-icon-" + ra + "'/>line314-5</span>" : da) + "</span><span class='fc-button-effect'>line314-6<span></span></span></span></span>");
                            if (na) {
                                na.click(function () {
    ...
    function sb(a, b, e) {
        ...
        function g(w,
            ...
            for (aa = 0; aa < F; aa++) R += "<th class='fc- " + V + "'/>line1063";
            R += "</tr></thead><tbody>";
            for (aa = 0; aa < w; aa++) {
                R += "<tr class='fc-week" + aa + "'>";
                for (V = 0; V < F; V++) R += "<td class='fc- " + ea + " fc-day" + (aa * F + V) + "'>line1067<div>line1067-1" + (I ? "<div class='fc-day-number'/>line1067-2" : "lineeeee") + "<div class='fc-day-content'>line1067-3<div style='position:relative'>line1067-4&nbsp;</div></div></div></td>";
                R += "</tr>"
            }
            R += "</tbody></table>";
            w = m(R).appendTo(a);
            ...
            y(E);
            Y = m("<div style='position:absolute;z-index:8;top:0;left:0'/>line1083").appendTo(a)
        }
        function l(w) {
            var I = w || v == 1,
                R = p.start.getMonth(),
    ...
    function Rb(a, b, e) {
        ...
        function g() {
            ...
            x = "<table style='width:100%' class='fc-agenda-days fc-border-separate' cellspacing='0'><thead><tr><th class='fc-agenda-axis " + h + "'>1476&nbsp;</th>";
            for (A = 0; A < Ba; A++) x += "<th class='fc- fc-col" + A + " " + h + "'/>";
            x += "<th class='fc-agenda-gutter " + h + "'>line1478&nbsp;</th></tr></thead><tbody><tr><th class='fc-agenda-axis " + h + "'>line1478-2&nbsp;</th>";
            for (A = 0; A < Ba; A++) x += "<td class='fc- fc-col" + A + " " + O + "'>line1479<div>line1479-1<div class='fc-day-content'>line1479-2<div style='position:relative'>line1479-3&nbsp;</div>11</div>22</div>33</td>";
            x += "<td class='fc-agenda-gutter " + O + "'>line1480&nbsp;</td></tr></tbody></table>";
            v = m(x).appendTo(a);
            F = v.find("thead");
            ...
            ja = m("<div style='position:absolute;z-index:2;left:0;width:100%'/>line1493").appendTo(a);
            if (i("allDaySlot")) {
                ia = m("<div style='position:absolute;z-index:8;top:0;left:0'/>line1495").appendTo(ja);
                x = "<table style='width:100%' class='fc-agenda-allday' cellspacing='0'><tr><th class='" + h + " fc-agenda-axis'>line1496--1" + i("allDayText") + "</th><td>line1496-0<div class='fc-day-content'>line1496<div style='position:relative'/>line1496-2</div></td><th class='" + h + " fc-agenda-gutter'>line1496-3&nbsp;</th></tr></table>";
                la = m(x).appendTo(ja);
                $ = la.find("tr");
                q($.find("td"));
                aa = aa.add(la.find("th:first"));
                va = va.add(la.find("th.fc-agenda-gutter"));
                ja.append("<div class='fc-agenda-divider " + h + "'>line1502<div class='fc-agenda-divider-inner'/>line1502-2</div>")
            } else ia = m([]);
            w = m("<div style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>line1504").appendTo(ja);
            I = m("<div style='position:relative;width:100%;overflow:hidden'/>line1505").appendTo(w);
            R = m("<div style='position:absolute;z-index:8;top:0;left:0'/>line1506").appendTo(I);
            ...
            for (A = tb = 0; ta < za; A++) {
                Da = ta.getMinutes();
                x += "<tr class='fc-slot" + A + " " + (!Da ? "" : "fc-minor") + "'><th class='fc-agenda-axis " + h + "'>line1513-0" + (!Ea || !Da ? s(ta, i("axisFormat")) : "line13-int&nbsp;") + "</th><td class='" + O + "'>line1513-1<div style='position:relative'>line1513-2&nbsp;</div></td></tr>";
                xa(ta, i("slotMinutes"));
                tb++
            }
            x += "</tbody></table>";
    ...
    function sc() {
        ...
        function l(o, s) {
            ...
            v += " class='" + M.join(" ") + "' style='position:absolute;z-index:8;top:" + s.top + "px;left:" + s.left + "px;" + r + "'><div class='fc-event-inner fc-event-skin'" + J + ">line2036<div class='fc-event-head fc-event-skin'" + J + ">line2036-2<div class='fc-event-time'>line2036-3" + Qa(W(o.start, o.end, u("timeFormat"))) + "</div></div><div class='fc-event-content'>line2036-4<div class='fc-event-title'>line2036-5" + Qa(o.title) + "</div></div><div class='fc-event-bg'>line2036-6</div></div>";
